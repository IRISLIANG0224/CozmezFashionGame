...
export const NYT_CLOTHING_ITEMS = [
  ...
  // NYT Chains
  {
    ...
    uiImage: NYTChain1UI,
    mainImage: NYTChain1,
    position: { x: 100, y: 150, zIndex: 20 }
  },
  {
    id: 'NC002',
    type: CLOTHING_TYPES.ACCESSORIES,
  ...
  // NYT Tops
  {
    ...
    uiImage: NYTTop1UI,
    mainImage: NYTTop1,
    position: { x: 100, y: 150, zIndex: 10 }
  },
  {
    id: 'NT002',
    type: CLOTHING_TYPES.TOPS,
  ...
  // NYT Coats with base layers
  {
    ...
    position: { x: 100, y: 150, zIndex: 15 },
    basePosition: { x: 100, y: 150, zIndex: 14 }
  },
  {
    id: 'NCT002',
    type: CLOTHING_TYPES.TOPS,
  ...
  },
  {
    ...
    position: { x: 100, y: 150, zIndex: 13 },
    basePosition: { x: 100, y: 150, zIndex: 12 }
  },
  {
    id: 'NOCT001',
    type: CLOTHING_TYPES.TOPS,
    ...
    position: { x: 100, y: 150, zIndex: 17 },
    basePosition: { x: 100, y: 150, zIndex: 16 }
  },
...
export const KNT_CLOTHING_ITEMS = [
  ...
  },
  {
    ...
    position: { x: 100, y: 150, zIndex: 10 },
    basePosition: { x: 100, y: 150, zIndex: 9 }
  },
  {
    id: 'KT003',
    type: CLOTHING_TYPES.TOPS,
...
export const getItemsByType = (type, character) => 
  CLOTHING_ITEMS.filter(item => 
    item.type === type && item.character === character
  );
...
export const getItemsBySlot = (slot, character) =>
  CLOTHING_ITEMS.filter(item => 
    item.slot === slot && item.character === character
  );
...
export const KNT_FOOTWEAR = getItemsByType(CLOTHING_TYPES.FOOTWEAR, CHARACTERS.KNT);
export const KNT_ACCESSORIES = getItemsByType(CLOTHING_TYPES.ACCESSORIES, CHARACTERS.KNT);
...
export const canEquipItem = (item, currentOutfit) => {
  ...
  return currentOutfit[item.slot] === '0' || currentOutfit[item.slot] === item.id;
};
